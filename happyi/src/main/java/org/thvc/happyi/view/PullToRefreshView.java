...
public class PullToRefreshView extends LinearLayout {
    ...
    private void headerRefreshing() {
        ...
        mHeaderTextView.setText(R.string.loading);
        getLastUpdateTIme();
    ...
    public void setLastUpdateTIme() {
        ...
        String lastUpdateTime = "最近更新: " + simpleDateFormat.format(date) + "";
        SharedPreferencesUtil.saveData(getContext(), "lastUpdateTime", lastUpdateTime);
        if (lastUpdateTime != null) {
            mHeaderUpdateTextView.setVisibility(View.VISIBLE);
            mHeaderUpdateTextView.setText(lastUpdateTime);
        } else {
    ...
    public String getLastUpdateTIme() {
        ...
        Date date = new Date();
        String lastUpdateTime = "最近更新: " + simpleDateFormat.format(date) + "";
        lastUpdateTime = SharedPreferencesUtil.getData(getContext(), "lastUpdateTime", lastUpdateTime) + "";
