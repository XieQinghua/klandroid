...
public class FansAdapter extends BaseAdapter {
    ...
    public FansAdapter(Context context, ArrayList<FansBean.DataEntity.ListEntity> list, Handler handler) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (list.get(position).getMembertype() != null) {
            if (list.get(position).getMembertype().equals("2")) {
                ...
                if (list.get(position).getHasCollected() == 1) {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                if (new JsonValidator().validate(result)) {
                    ...
                    if (collectBean.getStatus() == 1) {
                        ...
                        handler.sendEmptyMessage(RefreshFragment.REFRESH);
                    } else {
