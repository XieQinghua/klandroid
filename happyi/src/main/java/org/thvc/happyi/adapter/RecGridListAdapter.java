 ...
 */
public class RecGridListAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<HomeIndexBean.DataEntity.RecEntity.RecDataEntity>list;

    public RecGridListAdapter(Context context, ArrayList<HomeIndexBean.DataEntity.RecEntity.RecDataEntity> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            vh = new ViewHolder();
            convertView = LayoutInflater.from(context).inflate(R.layout.item_party_label, null);
