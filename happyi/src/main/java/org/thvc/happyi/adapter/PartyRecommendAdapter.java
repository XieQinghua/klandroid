...
/**
 * 项目名称：klandroid
 * 类描述：推荐活动的Adapter，有多处共用（首页推荐活动，搜索页面，首页便签查询进入页面）
 * 创建人：谢庆华.
 * 创建时间：2015/11/12 16:18
 * 修改人：Administrator
 * 修改时间：2015/11/12 16:18
 */
public class PartyRecommendAdapter extends BaseAdapter {
    ...
    public PartyRecommendAdapter(Context context, ArrayList<HomeIndexBean.DataEntity.HotEntity.HotDataEntity> list) {
